...
function fixtureSource(): string {
  ...
  const catalog: Catalog = {
    ...
    rules: {
      alpha: { description: 'x', tags: ['core'], requires: [], scope: 'global', path: 'rules/alpha.md', profiles: ['demo'] },
      beta: { description: 'x', tags: ['core'], requires: [], scope: 'global', path: 'rules/beta.md', profiles: [] },
