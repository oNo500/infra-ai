...
description: >-
  Provides templates and guidelines for creating new Skills. Use this skill as a
  starting point when creating a new skill or when asking about skill structure
  and best practices.
